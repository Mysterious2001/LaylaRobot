...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/MysticRobot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="ᴀʙᴏᴜᴛ", callback_data="Mystic_"),
        InlineKeyboardButton(
            text="ꜱᴜᴘᴘᴏʀᴛ", url=f"https://t.me/{SUPPORT_CHAT}"
        ),
    ],
    [
        InlineKeyboardButton(text="ʟᴏɢꜱ", url=f"https://t.me/l
Mysticlogs"),
        InlineKeyboardButton(
...
Mystic_IMG =https://telegra.ph/file/3ea0c7795b2b2bb58b154.jpg
...
@run_async
def Mystic_about_callback(update, context):
    query = update.callback_query
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Mystic*, a powerful group management bot built to help you manage your group easily.
